...
public class mahdiPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mahdi_page);
    }

    public void mahdiFace(View view) {

        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://facebook.com/mahdi.babaei"));
        startActivity(intent);
    }


    public void sendMahdi(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"mahdi.babaei@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Mr. Mahdi\n\n\n\n" +
                "\n" +
                "\n" +
