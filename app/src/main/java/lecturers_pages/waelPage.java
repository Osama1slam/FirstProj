...
public class waelPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wael_page);
    }
    public void sendWael(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"wael.fawkhiri@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Mr. Wael\n\n\n\n" +
                "\n" +
                "\n" +
    ...
    public void waelFace(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/wael.fawakhiri?ref=ts"));
        startActivity(intent);
    }
