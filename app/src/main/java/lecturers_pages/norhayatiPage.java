...
public class norhayatiPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_norhayati_page);
    }


    public void sendHayati(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"hayati.idrus@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Ms. Norhayati\n\n\n\n" +
                "\n" +
                "\n" +
    ...
    public void hayatiFace(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/norhayati.idris.96?ref=ts"));
        startActivity(intent);
    }
