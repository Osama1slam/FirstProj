...
public class shalikenPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shaliken_page);
    }
    public void sendShaliken(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"shaliken.tuerwahong@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Ms. Shaliken\n\n\n\n" +
                "\n" +
                "\n" +
