...
public class marwanPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_marwan_page);
    }

    public void sendMarwan(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"marwan.aljemeli@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Dr. Marwan\n\n\n\n" +
                "\n" +
                "\n" +
    ...
    public void marwanFace(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/profile.php?id=100009285641927"));
        startActivity(intent);
    }
