...
public class izanPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_izan_page);
    }

    public void sendIzan(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"izan@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Ms. Izan\n\n\n\n" +
                "\n" +
                "\n" +
    ...
    public void callIzan(View view) {

        Intent intent = new Intent(Intent.ACTION_CALL);
        intent.setData(Uri.parse("tel:+60176745485"));
