...
public class norisPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_noris_page);
    }
    public void sendNoris(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"noris@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Ms. Noris\n\n\n\n" +
                "\n" +
                "\n" +
    ...
    public void norisFace(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/noris.ismail.50?ref=ts"));
        startActivity(intent);
    }
