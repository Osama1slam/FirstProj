...
public class vinodPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vinod_page);
    }

    public void sendVinod(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"vinod.ramanathan@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Mr. Vinod\n\n\n\n" +
                "\n" +
                "\n" +
    ...
    public void mahdiFace(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://facebook.com/rvinodsarna"));
        startActivity(intent);
    }
