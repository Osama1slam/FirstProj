...
public class kelvinPage extends Activity {
    ...
    public void sendKelvin(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"kelvin.kimani@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Mr. Kelvin\n\n\n\n" +
                "\n" +
                "\n" +
    ...
    public void kelvinFace(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/K3LL2"));
        startActivity(intent);
    }
