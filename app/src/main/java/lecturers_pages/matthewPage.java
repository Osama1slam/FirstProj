...
public class matthewPage extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_matthew_page);
    }

    public void sendMatt(View view) {
        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"matthew@limkokwing.edu.my"});
        intent.putExtra(Intent.EXTRA_TEXT, "Hello Mr. Matthew\n\n\n\n" +
                "\n" +
                "\n" +
    ...
    public void mattFace(View view) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/matthew.wee.16"));
        startActivity(intent);
    }
